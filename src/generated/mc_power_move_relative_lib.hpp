...
struct ECMC_AXIS_REF {
    IEC_DINT AXISINDEX{};
};

using IEC_ECMC_AXIS_REF = ECMC_AXIS_REF;
...
public:
    ...
    IEC_BOOL EXECUTE;
    IEC_DINT SEQID;
    IEC_LREAL HOMEPOSITION;
    IEC_LREAL VELOCITYTOWARDSCAM;
    IEC_LREAL VELOCITYOFFCAM;
    IEC_LREAL ACCELERATION;
    IEC_LREAL DECELERATION;
    // Outputs
    IEC_BOOL DONE;
...
class Program_MC_POWER_MOVE_RELATIVE_LIB;

class Program_MC_POWER_MOVE_RELATIVE_LIB : public ProgramBase {
public:
    // Local variables
    ECMC_AXIS_REF AXIS;
    MC_POWER POWER;
    MC_MOVERELATIVE MOVEREL;
    MC_READSTATUS READSTATUS;
    MC_READACTUALPOSITION READPOS;
    IEC_BOOL ENABLECMD;  // AT %IX0.0
    IEC_BOOL EXECUTECMD;  // AT %IX0.1
    IEC_LREAL DISTANCECMD;  // AT %IL8
    IEC_LREAL VELOCITYCMD;  // AT %IL16
    IEC_LREAL ACCELCMD;  // AT %IL24
    IEC_LREAL DECELCMD;  // AT %IL32
    IEC_BOOL POWERSTATUS;  // AT %QX0.0
    IEC_BOOL POWERVALID;  // AT %QX0.1
    IEC_BOOL MOVEBUSY;  // AT %QX0.2
    IEC_BOOL MOVEDONE;  // AT %QX0.3
    IEC_BOOL MOVEERROR;  // AT %QX0.4
    IEC_BOOL STANDSTILL;  // AT %QX0.5
    IEC_BOOL DISCRETEMOVE;  // AT %QX0.6
    IEC_BOOL ERRORSTOP;  // AT %QX0.7
    IEC_UDINT MOVEERRORID;  // AT %QD4
    IEC_LREAL ACTUALPOS;  // AT %QL8

    // Constructor
    Program_MC_POWER_MOVE_RELATIVE_LIB();
...
// Forward: ENABLECMD AT %IX0.0 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: EXECUTECMD AT %IX0.1 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: DISTANCECMD AT %IL8 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: VELOCITYCMD AT %IL16 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: ACCELCMD AT %IL24 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: DECELCMD AT %IL32 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: POWERSTATUS AT %QX0.0 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: POWERVALID AT %QX0.1 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: MOVEBUSY AT %QX0.2 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: MOVEDONE AT %QX0.3 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: MOVEERROR AT %QX0.4 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: STANDSTILL AT %QX0.5 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: DISCRETEMOVE AT %QX0.6 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: ERRORSTOP AT %QX0.7 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: MOVEERRORID AT %QD4 in Program_MC_POWER_MOVE_RELATIVE_LIB
// Forward: ACTUALPOS AT %QL8 in Program_MC_POWER_MOVE_RELATIVE_LIB

extern LocatedVar locatedVars[16];
constexpr uint32_t locatedVarsCount = 16;
