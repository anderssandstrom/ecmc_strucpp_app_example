...
class Program_MOTION_ACTPOS_MIRROR;

class Program_MOTION_ACTPOS_MIRROR : public ProgramBase {
public:
    // Local variables
    IEC_LREAL SOURCE_ACTPOS;  // AT %IL0
    IEC_LREAL TARGET_POSITION;  // AT %QL0

    // Constructor
    Program_MOTION_ACTPOS_MIRROR();
...
// Forward: SOURCE_ACTPOS AT %IL0 in Program_MOTION_ACTPOS_MIRROR
// Forward: TARGET_POSITION AT %QL0 in Program_MOTION_ACTPOS_MIRROR

extern LocatedVar locatedVars[2];
