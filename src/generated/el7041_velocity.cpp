...
LocatedVar locatedVars[3] = {
    { LocatedArea::Input, LocatedSize::Word, 0, 0, {0, 0, 0}, nullptr },  // ACTUAL_POSITION AT %IW0
    { LocatedArea::Output, LocatedSize::Word, 0, 0, {0, 0, 0}, nullptr },  // DRIVE_CONTROL AT %QW0
    { LocatedArea::Output, LocatedSize::Word, 2, 0, {0, 0, 0}, nullptr }  // VELOCITY_SETPOINT AT %QW2
};

Program_EL7041_VELOCITY::Program_EL7041_VELOCITY()
    : ACTUAL_POSITION(0), DRIVE_CONTROL(0), VELOCITY_SETPOINT(0)
{
    // Initialize located variable pointers
    locatedVars[0].pointer = ACTUAL_POSITION.raw_ptr();
    locatedVars[1].pointer = DRIVE_CONTROL.raw_ptr();
    locatedVars[2].pointer = VELOCITY_SETPOINT.raw_ptr();
}

void Program_EL7041_VELOCITY::run() {
