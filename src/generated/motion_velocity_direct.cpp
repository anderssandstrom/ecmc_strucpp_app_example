...
#include "motion_velocity_direct.hpp"
...
LocatedVar locatedVars[3] = {
    { LocatedArea::Input, LocatedSize::LWord, 0, 0, {0, 0, 0}, nullptr },  // ACTUAL_POSITION AT %IL0
    { LocatedArea::Output, LocatedSize::LWord, 0, 0, {0, 0, 0}, nullptr },  // TARGET_VELOCITY AT %QL0
    { LocatedArea::Output, LocatedSize::Bit, 8, 0, {0, 0, 0}, nullptr }  // DRIVE_ENABLE AT %QX8.0
};

Program_MOTION_VELOCITY_DIRECT::Program_MOTION_VELOCITY_DIRECT()
    : ACTUAL_POSITION(0.0), TARGET_VELOCITY(0.0), DRIVE_ENABLE(false)
{
    // Initialize located variable pointers
    locatedVars[0].pointer = ACTUAL_POSITION.raw_ptr();
    locatedVars[1].pointer = TARGET_VELOCITY.raw_ptr();
    locatedVars[2].pointer = DRIVE_ENABLE.raw_ptr();
}

void Program_MOTION_VELOCITY_DIRECT::run() {
    DRIVE_ENABLE = true;
    if (ACTUAL_POSITION < 1000.0) {
