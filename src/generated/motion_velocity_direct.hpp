...
class Program_MOTION_VELOCITY_DIRECT;

class Program_MOTION_VELOCITY_DIRECT : public ProgramBase {
public:
    // Local variables
    IEC_LREAL ACTUAL_POSITION;  // AT %IL0
    IEC_LREAL TARGET_VELOCITY;  // AT %QL0
    IEC_BOOL DRIVE_ENABLE;  // AT %QX8.0

    // Constructor
    Program_MOTION_VELOCITY_DIRECT();
...
// Forward: ACTUAL_POSITION AT %IL0 in Program_MOTION_VELOCITY_DIRECT
// Forward: TARGET_VELOCITY AT %QL0 in Program_MOTION_VELOCITY_DIRECT
// Forward: DRIVE_ENABLE AT %QX8.0 in Program_MOTION_VELOCITY_DIRECT
