...
class Program_EL7041_VELOCITY;

class Program_EL7041_VELOCITY : public ProgramBase {
public:
    // Local variables
    IEC_INT ACTUAL_POSITION;  // AT %IW0
    IEC_WORD DRIVE_CONTROL;  // AT %QW0
    IEC_INT VELOCITY_SETPOINT;  // AT %QW2

    // Constructor
    Program_EL7041_VELOCITY();
...
// Forward: ACTUAL_POSITION AT %IW0 in Program_EL7041_VELOCITY
// Forward: DRIVE_CONTROL AT %QW0 in Program_EL7041_VELOCITY
// Forward: VELOCITY_SETPOINT AT %QW2 in Program_EL7041_VELOCITY
