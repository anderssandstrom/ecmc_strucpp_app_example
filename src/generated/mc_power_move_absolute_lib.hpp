...
class Program_MC_POWER_MOVE_ABSOLUTE_LIB;

class Program_MC_POWER_MOVE_ABSOLUTE_LIB : public ProgramBase {
public:
    // Local variables
    ECMC_AXIS_REF AXIS;
    MC_POWER POWER;
    MC_MOVEABSOLUTE MOVEABS;
    MC_READACTUALPOSITION READPOS;
    IEC_BOOL ENABLECMD;  // AT %IX0.0
    IEC_BOOL EXECUTECMD;  // AT %IX0.1
    IEC_LREAL TARGETPOS;  // AT %IL8
    IEC_LREAL VELOCITY;  // AT %IL16
    IEC_LREAL ACCEL;  // AT %IL24
    IEC_LREAL DECEL;  // AT %IL32
    ...
    // Constructor
    Program_MC_POWER_MOVE_ABSOLUTE_LIB();
...
// Forward: ENABLECMD AT %IX0.0 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: EXECUTECMD AT %IX0.1 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: TARGETPOS AT %IL8 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: VELOCITY AT %IL16 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: ACCEL AT %IL24 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: DECEL AT %IL32 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: POWERSTATUS AT %QX0.0 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: POWERVALID AT %QX0.1 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: MOVEBUSY AT %QX0.2 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: MOVEDONE AT %QX0.3 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: MOVEERROR AT %QX0.4 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: MOVEERRORID AT %QD4 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
// Forward: ACTUALPOS AT %QL8 in Program_MC_POWER_MOVE_ABSOLUTE_LIB
