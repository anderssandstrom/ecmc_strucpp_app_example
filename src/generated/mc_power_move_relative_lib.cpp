...
#include "mc_power_move_relative_lib.hpp"
...
void MC_RESET::operator()() {
    auto *handle = reinterpret_cast<ecmcMcResetHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcResetCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        ecmcMcResetStatus fb_status{};
        ecmcMcResetRun(handle, AXIS.AXISINDEX.get(), EXECUTE.get() ? 1 : 0, &fb_status);
...
void MC_MOVERELATIVE::operator()() {
    auto *handle = reinterpret_cast<ecmcMcMoveRelativeHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcMoveRelativeCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        ecmcMcMoveRelativeStatus fb_status{};
        ecmcMcMoveRelativeRun(handle,
                              AXIS.AXISINDEX.get(),
                              EXECUTE.get() ? 1 : 0,
                              DISTANCE.get(),
                              VELOCITY.get(),
...
void MC_MOVEVELOCITY::operator()() {
    auto *handle = reinterpret_cast<ecmcMcMoveVelocityHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcMoveVelocityCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }

      if (!handle) {
        INVELOCITY.set(false);
        BUSY.set(false);
        ACTIVE.set(false);
        COMMANDABORTED.set(false);
        ERROR.set(true);
        ...
        ecmcMcMoveVelocityStatus fb_status{};
        ecmcMcMoveVelocityRun(handle,
                              AXIS.AXISINDEX.get(),
                              EXECUTE.get() ? 1 : 0,
                              VELOCITY.get(),
                              ACCELERATION.get(),
                              DECELERATION.get(),
                              &fb_status);
        INVELOCITY.set(fb_status.InVelocity != 0);
        BUSY.set(fb_status.base.Busy != 0);
        ACTIVE.set(fb_status.base.Active != 0);
        COMMANDABORTED.set(fb_status.base.CommandAborted != 0);
        ERROR.set(fb_status.base.Error != 0);
...
void MC_HOME::operator()() {
    auto *handle = reinterpret_cast<ecmcMcHomeHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcHomeCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        ecmcMcHomeStatus fb_status{};
        ecmcMcHomeRun(handle,
                      AXIS.AXISINDEX.get(),
                      EXECUTE.get() ? 1 : 0,
                      static_cast<int>(SEQID.get()),
                      HOMEPOSITION.get(),
                      VELOCITYTOWARDSCAM.get(),
                      VELOCITYOFFCAM.get(),
                      ACCELERATION.get(),
                      DECELERATION.get(),
                      &fb_status);
...
void MC_HALT::operator()() {
    auto *handle = reinterpret_cast<ecmcMcHaltHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcHaltCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        ecmcMcHaltStatus fb_status{};
        ecmcMcHaltRun(handle, AXIS.AXISINDEX.get(), EXECUTE.get() ? 1 : 0, &fb_status);
        DONE.set(fb_status.base.Done != 0);
        BUSY.set(fb_status.base.Busy != 0);
        ACTIVE.set(fb_status.base.Active != 0);
        COMMANDABORTED.set(fb_status.base.CommandAborted != 0);
...
void MC_READSTATUS::operator()() {
    auto *handle = reinterpret_cast<ecmcMcReadStatusHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcReadStatusCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        STOPPING.set(false);
        HOMING.set(false);
        STANDSTILL.set(false);
        DISCRETEMOTION.set(false);
        CONTINUOUSMOTION.set(false);
        SYNCHRONIZEDMOTION.set(false);
      } else {
        ecmcMcReadStatusStatus fb_status{};
        ecmcMcReadStatusRun(handle, AXIS.AXISINDEX.get(), ENABLE.get() ? 1 : 0, &fb_status);
        VALID.set(fb_status.Valid != 0);
        BUSY.set(fb_status.base.Busy != 0);
        ERROR.set(fb_status.base.Error != 0);
        ERRORID.set(static_cast<UDINT_t>(fb_status.base.ErrorID));
        ERRORSTOP.set(fb_status.ErrorStop != 0);
        DISABLED.set(fb_status.Disabled != 0);
        STOPPING.set(fb_status.Stopping != 0);
        HOMING.set(fb_status.Homing != 0);
        STANDSTILL.set(fb_status.StandStill != 0);
        DISCRETEMOTION.set(fb_status.DiscreteMotion != 0);
        CONTINUOUSMOTION.set(fb_status.ContinuousMotion != 0);
        SYNCHRONIZEDMOTION.set(fb_status.SynchronizedMotion != 0);
      }
}
...
void MC_READACTUALVELOCITY::operator()() {
    auto *handle = reinterpret_cast<ecmcMcReadActualVelocityHandle *>(static_cast<uintptr_t>(STATEPTR.get()));
      if (!handle) {
        handle = ecmcMcReadActualVelocityCreate();
        STATEPTR.set(static_cast<ULINT_t>(reinterpret_cast<uintptr_t>(handle)));
      }
      ...
      if (!handle) {
        ...
        ecmcMcReadActualVelocityStatus fb_status{};
        ecmcMcReadActualVelocityRun(handle, AXIS.AXISINDEX.get(), ENABLE.get() ? 1 : 0, &fb_status);
        VALID.set(fb_status.Valid != 0);
        BUSY.set(fb_status.base.Busy != 0);
        ERROR.set(fb_status.base.Error != 0);
        ERRORID.set(static_cast<UDINT_t>(fb_status.base.ErrorID));
        VELOCITY.set(fb_status.Velocity);
      }
}
...
LocatedVar locatedVars[16] = {
    { LocatedArea::Input, LocatedSize::Bit, 0, 0, {0, 0, 0}, nullptr },  // ENABLECMD AT %IX0.0
    { LocatedArea::Input, LocatedSize::Bit, 0, 1, {0, 0, 0}, nullptr },  // EXECUTECMD AT %IX0.1
    { LocatedArea::Input, LocatedSize::LWord, 8, 0, {0, 0, 0}, nullptr },  // DISTANCECMD AT %IL8
    { LocatedArea::Input, LocatedSize::LWord, 16, 0, {0, 0, 0}, nullptr },  // VELOCITYCMD AT %IL16
    { LocatedArea::Input, LocatedSize::LWord, 24, 0, {0, 0, 0}, nullptr },  // ACCELCMD AT %IL24
    { LocatedArea::Input, LocatedSize::LWord, 32, 0, {0, 0, 0}, nullptr },  // DECELCMD AT %IL32
    { LocatedArea::Output, LocatedSize::Bit, 0, 0, {0, 0, 0}, nullptr },  // POWERSTATUS AT %QX0.0
    { LocatedArea::Output, LocatedSize::Bit, 0, 1, {0, 0, 0}, nullptr },  // POWERVALID AT %QX0.1
    { LocatedArea::Output, LocatedSize::Bit, 0, 2, {0, 0, 0}, nullptr },  // MOVEBUSY AT %QX0.2
    { LocatedArea::Output, LocatedSize::Bit, 0, 3, {0, 0, 0}, nullptr },  // MOVEDONE AT %QX0.3
    { LocatedArea::Output, LocatedSize::Bit, 0, 4, {0, 0, 0}, nullptr },  // MOVEERROR AT %QX0.4
    { LocatedArea::Output, LocatedSize::Bit, 0, 5, {0, 0, 0}, nullptr },  // STANDSTILL AT %QX0.5
    { LocatedArea::Output, LocatedSize::Bit, 0, 6, {0, 0, 0}, nullptr },  // DISCRETEMOVE AT %QX0.6
    { LocatedArea::Output, LocatedSize::Bit, 0, 7, {0, 0, 0}, nullptr },  // ERRORSTOP AT %QX0.7
    { LocatedArea::Output, LocatedSize::DWord, 4, 0, {0, 0, 0}, nullptr },  // MOVEERRORID AT %QD4
    { LocatedArea::Output, LocatedSize::LWord, 8, 0, {0, 0, 0}, nullptr }  // ACTUALPOS AT %QL8
};

Program_MC_POWER_MOVE_RELATIVE_LIB::Program_MC_POWER_MOVE_RELATIVE_LIB()
    : ENABLECMD(false), EXECUTECMD(false), DISTANCECMD(0.0), VELOCITYCMD(0.0), ACCELCMD(0.0), DECELCMD(0.0), POWERSTATUS(false), POWERVALID(false), MOVEBUSY(false), MOVEDONE(false), MOVEERROR(false), STANDSTILL(false), DISCRETEMOVE(false), ERRORSTOP(false), MOVEERRORID(0), ACTUALPOS(0.0)
{
    // Initialize located variable pointers
    locatedVars[0].pointer = ENABLECMD.raw_ptr();
    locatedVars[1].pointer = EXECUTECMD.raw_ptr();
    locatedVars[2].pointer = DISTANCECMD.raw_ptr();
    locatedVars[3].pointer = VELOCITYCMD.raw_ptr();
    locatedVars[4].pointer = ACCELCMD.raw_ptr();
    locatedVars[5].pointer = DECELCMD.raw_ptr();
    locatedVars[6].pointer = POWERSTATUS.raw_ptr();
    locatedVars[7].pointer = POWERVALID.raw_ptr();
    locatedVars[8].pointer = MOVEBUSY.raw_ptr();
    locatedVars[9].pointer = MOVEDONE.raw_ptr();
    locatedVars[10].pointer = MOVEERROR.raw_ptr();
    locatedVars[11].pointer = STANDSTILL.raw_ptr();
    locatedVars[12].pointer = DISCRETEMOVE.raw_ptr();
    locatedVars[13].pointer = ERRORSTOP.raw_ptr();
    locatedVars[14].pointer = MOVEERRORID.raw_ptr();
    locatedVars[15].pointer = ACTUALPOS.raw_ptr();
}

void Program_MC_POWER_MOVE_RELATIVE_LIB::run() {
    AXIS.AXISINDEX = 0;
    POWER.AXIS = AXIS;
    POWER.ENABLE = ENABLECMD;
    POWER();
    MOVEREL.AXIS = AXIS;
    MOVEREL.EXECUTE = EXECUTECMD;
    MOVEREL.DISTANCE = DISTANCECMD;
    MOVEREL.VELOCITY = VELOCITYCMD;
    MOVEREL.ACCELERATION = ACCELCMD;
    MOVEREL.DECELERATION = DECELCMD;
    MOVEREL();
    READSTATUS.AXIS = AXIS;
