...
class Program_MC_POWER_MOVE_VELOCITY_LIB;

class Program_MC_POWER_MOVE_VELOCITY_LIB : public ProgramBase {
public:
    // Local variables
    ECMC_AXIS_REF AXIS;
    MC_POWER POWER;
    MC_MOVEVELOCITY MOVEVEL;
    MC_READSTATUS READSTATUS;
    MC_READACTUALVELOCITY READVEL;
    IEC_BOOL ENABLECMD;  // AT %IX0.0
    IEC_BOOL EXECUTECMD;  // AT %IX0.1
    IEC_LREAL VELOCITYCMD;  // AT %IL8
    IEC_LREAL ACCELCMD;  // AT %IL16
    IEC_LREAL DECELCMD;  // AT %IL24
    IEC_BOOL POWERSTATUS;  // AT %QX0.0
    IEC_BOOL POWERVALID;  // AT %QX0.1
    IEC_BOOL INVELOCITY;  // AT %QX0.2
    IEC_BOOL MOVEBUSY;  // AT %QX0.3
    IEC_BOOL MOVEERROR;  // AT %QX0.4
    IEC_BOOL STANDSTILL;  // AT %QX0.5
    IEC_BOOL CONTMOTION;  // AT %QX0.6
    IEC_BOOL ERRORSTOP;  // AT %QX0.7
    IEC_UDINT MOVEERRORID;  // AT %QD4
    IEC_LREAL ACTUALVEL;  // AT %QL8

    // Constructor
    Program_MC_POWER_MOVE_VELOCITY_LIB();
...
// Forward: ENABLECMD AT %IX0.0 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: EXECUTECMD AT %IX0.1 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: VELOCITYCMD AT %IL8 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: ACCELCMD AT %IL16 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: DECELCMD AT %IL24 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: POWERSTATUS AT %QX0.0 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: POWERVALID AT %QX0.1 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: INVELOCITY AT %QX0.2 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: MOVEBUSY AT %QX0.3 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: MOVEERROR AT %QX0.4 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: STANDSTILL AT %QX0.5 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: CONTMOTION AT %QX0.6 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: ERRORSTOP AT %QX0.7 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: MOVEERRORID AT %QD4 in Program_MC_POWER_MOVE_VELOCITY_LIB
// Forward: ACTUALVEL AT %QL8 in Program_MC_POWER_MOVE_VELOCITY_LIB

extern LocatedVar locatedVars[15];
constexpr uint32_t locatedVarsCount = 15;
