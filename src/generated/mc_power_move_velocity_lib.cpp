...
#include "mc_power_move_velocity_lib.hpp"
...
LocatedVar locatedVars[15] = {
    ...
    { LocatedArea::Input, LocatedSize::LWord, 8, 0, {0, 0, 0}, nullptr },  // VELOCITYCMD AT %IL8
    { LocatedArea::Input, LocatedSize::LWord, 16, 0, {0, 0, 0}, nullptr },  // ACCELCMD AT %IL16
    { LocatedArea::Input, LocatedSize::LWord, 24, 0, {0, 0, 0}, nullptr },  // DECELCMD AT %IL24
    ...
    { LocatedArea::Output, LocatedSize::Bit, 0, 2, {0, 0, 0}, nullptr },  // INVELOCITY AT %QX0.2
    { LocatedArea::Output, LocatedSize::Bit, 0, 3, {0, 0, 0}, nullptr },  // MOVEBUSY AT %QX0.3
    ...
    { LocatedArea::Output, LocatedSize::Bit, 0, 6, {0, 0, 0}, nullptr },  // CONTMOTION AT %QX0.6
    ...
    { LocatedArea::Output, LocatedSize::LWord, 8, 0, {0, 0, 0}, nullptr }  // ACTUALVEL AT %QL8
};

Program_MC_POWER_MOVE_VELOCITY_LIB::Program_MC_POWER_MOVE_VELOCITY_LIB()
    : ENABLECMD(false), EXECUTECMD(false), VELOCITYCMD(0.0), ACCELCMD(0.0), DECELCMD(0.0), POWERSTATUS(false), POWERVALID(false), INVELOCITY(false), MOVEBUSY(false), MOVEERROR(false), STANDSTILL(false), CONTMOTION(false), ERRORSTOP(false), MOVEERRORID(0), ACTUALVEL(0.0)
{
    // Initialize located variable pointers
    locatedVars[0].pointer = ENABLECMD.raw_ptr();
    locatedVars[1].pointer = EXECUTECMD.raw_ptr();
    locatedVars[2].pointer = VELOCITYCMD.raw_ptr();
    locatedVars[3].pointer = ACCELCMD.raw_ptr();
    locatedVars[4].pointer = DECELCMD.raw_ptr();
    locatedVars[5].pointer = POWERSTATUS.raw_ptr();
    locatedVars[6].pointer = POWERVALID.raw_ptr();
    locatedVars[7].pointer = INVELOCITY.raw_ptr();
    locatedVars[8].pointer = MOVEBUSY.raw_ptr();
    locatedVars[9].pointer = MOVEERROR.raw_ptr();
    locatedVars[10].pointer = STANDSTILL.raw_ptr();
    locatedVars[11].pointer = CONTMOTION.raw_ptr();
    locatedVars[12].pointer = ERRORSTOP.raw_ptr();
    locatedVars[13].pointer = MOVEERRORID.raw_ptr();
    locatedVars[14].pointer = ACTUALVEL.raw_ptr();
}

void Program_MC_POWER_MOVE_VELOCITY_LIB::run() {
    AXIS.AXISINDEX = 0;
    POWER.AXIS = AXIS;
    POWER.ENABLE = ENABLECMD;
    POWER();
    MOVEVEL.AXIS = AXIS;
    MOVEVEL.EXECUTE = EXECUTECMD;
    MOVEVEL.VELOCITY = VELOCITYCMD;
    MOVEVEL.ACCELERATION = ACCELCMD;
    MOVEVEL.DECELERATION = DECELCMD;
    MOVEVEL();
