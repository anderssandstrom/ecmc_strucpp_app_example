...
#include "motion_actpos_mirror.hpp"
...
LocatedVar locatedVars[2] = {
    { LocatedArea::Input, LocatedSize::LWord, 0, 0, {0, 0, 0}, nullptr },  // SOURCE_ACTPOS AT %IL0
    { LocatedArea::Output, LocatedSize::LWord, 0, 0, {0, 0, 0}, nullptr }  // TARGET_POSITION AT %QL0
};

Program_MOTION_ACTPOS_MIRROR::Program_MOTION_ACTPOS_MIRROR()
    : SOURCE_ACTPOS(0.0), TARGET_POSITION(0.0)
{
    // Initialize located variable pointers
    locatedVars[0].pointer = SOURCE_ACTPOS.raw_ptr();
    locatedVars[1].pointer = TARGET_POSITION.raw_ptr();
}

void Program_MOTION_ACTPOS_MIRROR::run() {
    TARGET_POSITION = SOURCE_ACTPOS;
}
